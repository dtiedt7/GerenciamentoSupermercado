...
public class LoginController implements ActionListener {
	...
	public static final String TELA_NOTA_FISCAL = "NOTA_FISCAL";
	...
	public LoginController(TelaLogin tela, Supermercado supermercado, Navegador navegador, TelaCadastroProdutos telaProdutos,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == tela.getBtLogin()) {
			...
			Usuario usuario = supermercado.login(nome, cpf);
			if (usuario == null) {
			...
			if (usuario.getAdmin()) {
				ProdutosController.carregarTabela(telaProdutos, supermercado);
				...
				CompraController.recarregarProdutos(telaCompra, supermercado);
